...
namespace CustomAnalyzer.Test.Utilities
{
        ...
        static CodeFixProviderDiscovery()
        {
            ExportProviderFactory = new Lazy<IExportProviderFactory>(
                () =>
                {
                    ...
                    var parts = Task.Run(() => discovery.CreatePartsAsync(typeof(CustomAnalyzerCodeFixProvider).Assembly)).GetAwaiter().GetResult();
